...
def create_scheduler_app(settings: Settings | None = None) -> Any:
    """Create the Celery app used by the scheduler process."""

    resolved_settings = settings if settings is not None else get_settings()
    process_settings = resolved_settings.model_copy(update={"app_name": "scheduler"})
